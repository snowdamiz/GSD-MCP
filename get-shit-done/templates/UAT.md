...
- This section feeds directly into the `gsd_plan_phase` tool with gaps mode
...
5. status → "diagnosed"
6. Ready for the `gsd_plan_phase` tool with gaps mode and root causes
...
**Creation:** When the `gsd_verify_work` tool starts new session
