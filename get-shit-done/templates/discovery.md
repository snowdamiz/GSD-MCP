...
For deep ecosystem research ("how do experts build this"), use the `gsd_research_phase` tool which produces RESEARCH.md.
...
- Use the `gsd_research_phase` tool for these
</guidelines>
